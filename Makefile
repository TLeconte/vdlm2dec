...
vdlm2dec:	main.o rtl.o d8psk.o vdlm2.o viterbi.o rs.o crc.o outacars.o outxid.o
	$(CC)  main.o rtl.o d8psk.o vdlm2.o viterbi.o rs.o crc.o outacars.o outxid.o -o $@ $(LDLIBS)
